...
#define nstates1	3	/* checkLogic */
#define minseq1	87
#define maxseq1	88
#define endstate1	2

#define nstates0	88	/* Worker */
#define minseq0	0
#define maxseq0	86
#define endstate0	87
...
#define PcheckLogic	((P1 *)this)
typedef struct P1 { /* checkLogic */
...
#define Air0	(sizeof(P0) - Offsetof(P0, locked) - 5*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	int rescount[5];
...
#define Addproc(x)	addproc(256, 1, x)
#define LOCAL	1
#define Q_FULL_F	2
#define Q_EMPT_F	3
#define Q_EMPT_T	4
